...
public class Grafico {
    ...
    public static void Grafica(String fecha){
        Connection con;
    ...
    public static void Grafica2(String fecha){
        Connection con;
        Conexion cn= new Conexion();
        PreparedStatement ps;
        ResultSet rs;
        try{
           ...
           JFreeChart jf= ChartFactory.createPieChart3D("Total de ventas por dia", dataset);
           ChartFrame f= new ChartFrame("Total de ventas por dia",jf);
           f.setSize(1000,500);
           f.setLocationRelativeTo(null);
           f.setVisible(true);
